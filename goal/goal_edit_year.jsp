...
<form method="post" action="?">
    ...
    <p><input type="submit" class="btn btn--radius btn--orange" style="position: absolute; left: 0px; top: 680px" name="goal_delete" value="goal_delete" formaction="/UNION/goal/Goal_delete_year_parent"></p>
    <p><input type="submit" class="btn btn--radius btn--orange" style="position: absolute; left: 0px; top: 730px" value="goal_rename" formaction="/UNION/goal/Goal_rename_year_parent"></p>
</form>
